				...
				<table class="table table-hover">
					...
					<c:forEach items="${documents}" var="doc" varStatus="counter">
						<tr>
							...
							<td><a href="<c:url value='/admin/download-user-document-${user.id}-${doc.id}' />" class="btn btn-success custom-width">download</a></td>
							<td><a href="<c:url value='/admin/delete1-user-document-${user.id}-${doc.id}' />" class="btn btn-danger custom-width">delete</a></td>
						</tr>
					</c:forEach>
		    		</tbody>
		    	</table>
